...
<nav>
    <ul>
        <?php if (is_logged_in()) : ?>
            ...
            <li><a href="<?php echo get_url('view_competition.php'); ?>">Active Competitions</a></li>
            <li><a href="<?php echo get_url('my_competitions.php'); ?>">My Competitions</a></li>
        <?php endif; ?>
        <?php if (!is_logged_in()) : ?>
            <li><a href="<?php echo get_url('home.php'); ?>">Home</a></li>
            <li><a href="<?php echo get_url('game.php'); ?>">Play</a></li>
        ...
        <?php if (has_role("Admin")) : ?>
            <li><a href="<?php echo get_url('admin/edit_competition.php'); ?>">Edit Competitions</a></li>
